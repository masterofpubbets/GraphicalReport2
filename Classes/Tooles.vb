...
#Region "Database Methods"
            ...
            Public Sub Connect()
                ...
                Else
                    SqlServerCon = String.Format("packet size=8096;User ID={0};Initial Catalog={1};Persist Security Info=False;Data Source={2};password={3};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;", UserName, DataBaseName, Trim(DataBaseLocation), Pass)
                End If
                Try
            ...
            Public Function ExcuteNoneResult(ByVal Query As String, Optional ByVal Timeout As Integer = 0) As Boolean
                ...
                Return False
            End Function
            Private Function checkErrorFolder(ByVal path As String) As Boolean
                Try
            ...
            Private Sub ErrorLog(ByVal er As String, ByVal Description As String)
                Try
                    If checkErrorFolder(Application.StartupPath & "\error_log") Then
...
#Region "Methods"
            ...
            Public Function RemoveString(ByVal Value As String, ByVal RemoveType As enChars) As String
                ...
                Return ""
            End Function
            Public Function GetFileNameWithExtention(ByVal Path As String, Optional ByVal PathSeparator As String = "\") As String
                Try
...
#Region "Methods"
            ...
            Public Function GetFileNameWithExtention(ByVal Path As String, Optional ByVal PathSeparator As String = "\") As String
                ...
                Return ""
            End Function
            Public Function GetFileDirectory(ByVal Path As String, Optional ByVal PathSeparator As String = "\") As String
                Try
                    Dim t As String = ""
                    Dim temp() As String = Split(Path, PathSeparator)
                    For inx As Integer = 1 To UBound(temp) - 1
                        t = String.Format("{0}\{1}", t, temp(inx))
                    Next
                    If temp.Count > 0 Then t = String.Format("{0}{1}", temp(0), t)
                    Return t
                Catch ex As Exception
                End Try
                Return ""
...
KeyFound:
    ...
    Namespace MSOffice
        Public Class Excel
            ...
            Public Overloads Function GetSheetData(ByVal WorkBookPath As String, ByVal SheetName As String, Optional filter As String = "") As DataTable
                ...
                Return Nothing
            End Function
            Public Overloads Function GetSheetData(ByVal WorkBookPath As String, ByVal Query As String) As DataTable
                Dim cn As System.Data.OleDb.OleDbConnection
                Dim cmd As System.Data.OleDb.OleDbDataAdapter
                Dim ds As New DataSet
                Dim dt As New DataTable
                ...
                Try
                    ...
                    ' Select the data from Sheet1 of the workbook.
                    cmd = New System.Data.OleDb.OleDbDataAdapter(Query, cn)
                    cn.Open()
                    cmd.Fill(ds)
                    cn.Close()
                    dg.DataSource = ds.DefaultViewManager
                ...
                Return Nothing
            End Function
            Public Overloads Function GetSheetData(ByVal WorkBookPath As String, ByVal SheetName As String, ByVal SelectCols As String, Optional filter As String = "") As DataTable
                Dim cn As System.Data.OleDb.OleDbConnection
                Dim cmd As System.Data.OleDb.OleDbDataAdapter
                Dim ds As New DataSet
                Dim dt As New DataTable
